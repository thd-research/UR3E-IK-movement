...
#include "ur_msgs/srv/detail/set_analog_output__rosidl_typesupport_fastrtps_c.h"
...
#include "ur_msgs/msg/detail/analog__functions.h"  // data
...
using _SetAnalogOutput_Request__ros_msg_type = ur_msgs__srv__SetAnalogOutput_Request;
...
size_t get_serialized_size_ur_msgs__srv__SetAnalogOutput_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetAnalogOutput_Request__ros_msg_type * ros_message = static_cast<const _SetAnalogOutput_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetAnalogOutput_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_msgs__srv__SetAnalogOutput_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t max_serialized_size_ur_msgs__srv__SetAnalogOutput_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_msgs__srv__SetAnalogOutput_Request;
    is_plain =
      (
...
static size_t _SetAnalogOutput_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_msgs__srv__SetAnalogOutput_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_msgs, srv, SetAnalogOutput_Request)() {
...
using _SetAnalogOutput_Response__ros_msg_type = ur_msgs__srv__SetAnalogOutput_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t get_serialized_size_ur_msgs__srv__SetAnalogOutput_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetAnalogOutput_Response__ros_msg_type * ros_message = static_cast<const _SetAnalogOutput_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_msgs__srv__SetAnalogOutput_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t max_serialized_size_ur_msgs__srv__SetAnalogOutput_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_msgs__srv__SetAnalogOutput_Response;
    is_plain =
      (
...
static size_t _SetAnalogOutput_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_msgs__srv__SetAnalogOutput_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_msgs, srv, SetAnalogOutput_Response)() {
...
// already included above
// #include "ur_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ur_msgs/srv/set_analog_output.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_msgs, srv, SetAnalogOutput)() {
