...
#include "ur_msgs/srv/detail/set_force_mode__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose_stamped__functions.h"  // task_frame
#include "geometry_msgs/msg/detail/twist__functions.h"  // speed_limits
...
using _SetForceMode_Request__ros_msg_type = ur_msgs__srv__SetForceMode_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SetForceMode_Request__ros_msg_type * ros_message = static_cast<const _SetForceMode_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: deviation_limits
  {
    size_t size = 6;
    auto array_ptr = ros_message->deviation_limits;
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: damping_factor
  {
    cdr << ros_message->damping_factor;
  }

  // Field name: gain_scaling
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SetForceMode_Request__ros_msg_type * ros_message = static_cast<_SetForceMode_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: task_frame
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_ur_msgs__srv__SetForceMode_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetForceMode_Request__ros_msg_type * ros_message = static_cast<const _SetForceMode_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetForceMode_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_msgs__srv__SetForceMode_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t max_serialized_size_ur_msgs__srv__SetForceMode_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_msgs__srv__SetForceMode_Request;
    is_plain =
      (
...
static size_t _SetForceMode_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_msgs__srv__SetForceMode_Request(
...
static message_type_support_callbacks_t __callbacks_SetForceMode_Request = {
  "ur_msgs::srv",
...
static rosidl_message_type_support_t _SetForceMode_Request__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SetForceMode_Request,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_msgs, srv, SetForceMode_Request)() {
  return &_SetForceMode_Request__type_support;
}
...
using _SetForceMode_Response__ros_msg_type = ur_msgs__srv__SetForceMode_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SetForceMode_Response__ros_msg_type * ros_message = static_cast<const _SetForceMode_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SetForceMode_Response__ros_msg_type * ros_message = static_cast<_SetForceMode_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t get_serialized_size_ur_msgs__srv__SetForceMode_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetForceMode_Response__ros_msg_type * ros_message = static_cast<const _SetForceMode_Response__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetForceMode_Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_msgs__srv__SetForceMode_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t max_serialized_size_ur_msgs__srv__SetForceMode_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_msgs__srv__SetForceMode_Response;
    is_plain =
      (
...
static size_t _SetForceMode_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_msgs__srv__SetForceMode_Response(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_SetForceMode_Response = {
  "ur_msgs::srv",
...
static rosidl_message_type_support_t _SetForceMode_Response__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SetForceMode_Response,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_msgs, srv, SetForceMode_Response)() {
  return &_SetForceMode_Response__type_support;
}
...
static service_type_support_callbacks_t SetForceMode__callbacks = {
  "ur_msgs::srv",
  "SetForceMode",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_msgs, srv, SetForceMode_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_msgs, srv, SetForceMode_Response)(),
...
static rosidl_service_type_support_t SetForceMode__handle = {
  rosidl_typesupport_fastrtps_c__identifier,
  &SetForceMode__callbacks,
  get_service_typesupport_handle_function,
};

const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_msgs, srv, SetForceMode)() {
  return &SetForceMode__handle;
}
