...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ur_msgs, srv, SetPayload)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ur_msgs::srv::SetPayload>();
}
